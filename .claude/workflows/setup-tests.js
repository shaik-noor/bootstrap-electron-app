export const meta = {
  name: 'setup-tests',
  description: 'Scaffold the full test infrastructure: install Vitest + Testing Library + Playwright, create configs, and write the first tests for DatabaseService and IPC handlers',
  whenToUse: 'Run once to bootstrap the test setup from scratch — this project currently has no tests',
  phases: [
...
log('Test infrastructure scaffolded. Run `npm test` to execute, `npm run test:watch` for watch mode.')
